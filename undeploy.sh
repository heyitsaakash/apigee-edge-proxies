...
current_deployment_info=$(curl -H "Authorization: Basic YWFrYXNoc2hhcm0uYWE1QGhjbC5jb206JFNoYW5lMTIzNA==" "https://api.enterprise.apigee.com/v1/organizations/eu-west1-partner26/apis/my-apigee-api/deployments") 


echo "Retreived deployment info as below : "
